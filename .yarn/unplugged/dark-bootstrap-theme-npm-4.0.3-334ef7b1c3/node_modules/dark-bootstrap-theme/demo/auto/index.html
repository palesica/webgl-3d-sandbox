...
<html>
<head>
    <title>Dark Bootstrap Theme</title>
    <meta charset="utf-8" />
    ...
    <style>
        ...
        #light-theme-message, #dark-theme-message {
            display: none;
        }
...
<body>
    <nav class="navbar navbar-dark bg-primary mb-3">
        <div class="container">
            <a href="#" class="navbar-brand">Dark Bootstrap Theme</a>
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href="https://github.com/StrutTower/dark-bootstrap-theme" rel="noreferrer noopener" class="nav-link">
                        GitHub
                    </a>
                </li>
            </ul>
    ...
    <main class="container">
        <div id="not-supported-warning" class="text-center alert alert-danger" style="display:none;">
            Your browser does not support the prefers-color-scheme media query to automatically switch between light and dark themes. Defaulting to dark theme.
        </div>

        <div class="text-center alert alert-info" id="light-theme-message">
            <h5>prefers-color-scheme = <strong>light</strong></h5>
            <div>Change your device's system theme to change themes</div>
        </div>

        <div class="text-center alert alert-info" id="dark-theme-message">
            <h5>prefers-color-scheme = <strong>dark</strong></h5>
            <div>Change your device's system theme to change themes</div>
        </div>
        ...
        <p>
            ...
            <br />
            Credit: <a href="https://web.dev/prefers-color-scheme/">https://web.dev/prefers-color-scheme/</a>
        </p>
        <div class="card">
            <div class="card-body p-0">
                <pre class="px-3 pt-2"><code style="font-size:0.8rem;">&lt;head&gt;
    &lt;script&gt;
        <span class="text-success">// Fall back if the browser doesn't support prefers-color-scheme</span>
        if (window.matchMedia('(prefers-color-scheme: dark)').media === 'not all') {
            <span class="text-success">// Hide content until CSS loads to prevent show unstyled code.</span>
            document.documentElement.style.display = 'none'; 

            <span class="text-success">// Insert stylesheet with onload event to show page content.</span>
            document.head.insertAdjacentHTML(
                'beforeend',
                '&lt;link href="dark-theme.css" rel="stylesheet" onload="document.documentElement.style.display=\'\'" /&gt;'
            );
...
&lt;/head&gt;
        ...
        <div class="mb-4">
            ...
            <div class="row">
                <div class="col-12 col-sm-7">
                    <form>
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Default File input</label>
                                <input type="file" class="form-control-file" id="exampleInputFile" aria-describedby="fileHelp">
                                <small id="fileHelp" class="form-text text-muted">This is some placeholder block-level help text for the above input. It's a bit lighter and easily wraps to a new line.</small>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Custom File input</label>
                ...
                <div class="col-12 col-sm-6">
                    <fieldset>
                        <legend>Custom Select Lists</legend>
        ...
        <!-- Progress Bars -->
        <div class="mb-4">
            <h2 class="display-5">Progress Bars</h2>
            <hr />
            <p>
                <div class="progress">
        ...
        <!-- Containers -->
        <div class="mb-4">
            <h2 class="display-5">Containers</h2>
            <hr />
            <h4>Jumbotron</h4>
            <div class="jumbotron">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <p>
                        ...
                        <button type="button" class="btn btn-secondary" title="" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-original-title="Popover Title">
                            Bottom
                        </button>
        ...
        <!-- Code Elements -->
        <div class="mb-4">
            <h2 class="display-5">Code Elements</h2>
            <hr />
        ...
        <!-- Carousel -->
        <div class="mb-4">
            <h2 class="display-5">Carousel</h2>
            <hr />
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-block w-100" style="height:200px;background:#808080;text-align:center;">
                            <h3 style="padding-top:50px;">First slide</h3>
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="d-block w-100" style="height:200px;background:#808080;text-align:center;">
                            <h3 style="padding-top:50px;">Second slide</h3>
                        </div>
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Second slide</h5>
                            <p>Second slide</p>
                    ...
                    <div class="carousel-item">
                        <div class="d-block w-100" style="height:200px;background:#808080;text-align:center;">
                            <h3 style="padding-top:50px;">Third slide</h3>
                        </div>
                        <div class="carousel-caption d-none d-md-block">
                            <h5>Third slide</h5>
                            <p>Third slide</p>
        ...
        <!-- Spinners -->
        <div class="mb-4">
            <h2 class="display-5">Spinners</h2>
            <hr />
        ...
        <!-- Media Object -->
        <div class="mb-4">
            <h2 class="display-5">Media Object</h2>
            <hr />
            <div class="media">
                <div style="width:64px;height:64px;background:#868e96;" class="mr-3 text-center"><div class="pt-3">64x64</div></div>
        ...
        <!-- Custom Styles -->
        <div class="mb-4">
            <h2 class="display-5">Custom Styles</h2>
            <p class="text-muted">The following styles are not present in Bootstrap 4 and are added in by this theme.</p>
            <hr />
        ...
        <!--<div class="mb-4">
            <h2 class="display-5">Plugin Styles</h2>
            <p class="text-muted">The following are JavaScript plugins that have support in this theme.</p>
            <hr />

            <div class="form-group">
                <h3>Summernote <span class="h5"><a href="https://summernote.org/" target="_blank" rel="noopener noreferrer" class="small">https://summernote.org/</a></span></h3>

                <textarea id="summernote-test"></textarea>
            </div>

            <div class="form-group">
                <h3>Select2 <span class="h5"><a href="https://select2.org/" target="_blank" rel="noopener noreferrer" class="small">https://select2.org/</a></span></h3>

                <label>Single Select List</label>
                <select class="select2-test">
                ...
                <label>Multiple Select List</label>
            ...
            <div class="form-group">
                <h3>DateRangePicker <span class="h5"><a href="http://www.daterangepicker.com/" target="_blank" rel="noopener noreferrer" class="small">http://www.daterangepicker.com/</a></span></h3>


                <div class="form-group">
                    <label>Date Range</label>
                    <input type="text" id="daterangepicker-test-range" class="form-control" />
                </div>
                <div class="form-group">
                    <label>Single Date</label>
                    <input type="text" id="daterangepicker-test-single" class="form-control" />
                </div>
            </div>
        </div>-->
