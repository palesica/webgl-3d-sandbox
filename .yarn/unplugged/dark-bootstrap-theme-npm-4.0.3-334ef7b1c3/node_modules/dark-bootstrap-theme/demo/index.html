...
<head>
    ...
    <link href="../dist/dark-customStyles.min.css" rel="stylesheet" />
...
<body>
    ...
    <main class="container">
        ...
        <p>
            <a href="auto/index.html">Example using prefered-color-scheme media query to automatically switch between light and dark themes</a>
        </p>
